        ...
        <div class="biography-container">
            <div class="biography-upper">
                <div class="profile-picture">
                    ...
                    <?php else: ?>
                        <img src="databases/profile/<?php echo htmlspecialchars($akun['foto'])?>" alt="profile-picture" class="picture">
                    <?php endif;?>
                    <div class="biography">
                        ...
                        <div class="content-container">
                            ...
                            <figcaption class="caption-content">
                                <figure class="owner-content">
                                    <?php if ($akun["foto"] == "") {echo"<img src='assets/default.jpg' alt='profile' class='>";} else {echo"<img src='databases/profile/" . htmlspecialchars($akun["foto"]) . "' alt='profile' class='nav-profile-picture'>";}?>
