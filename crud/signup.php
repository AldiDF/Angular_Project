...
<body>
    ...
    <div>
        <a class="back-page" onclick="left_slide(2, 1)"><i class="fa-solid fa-arrow-left" style="font-size: 30px"></i></a>
    ...
    <main class="signup-page">
        <div class="login-container">
            <form action="" class="login-form-container" method="POST">
                ...
                <input type="text" id="full-name" name="full-name" class="form-login" required><br><br>
                <label for="email">Surel:</label>
                <input type="email" id="email" name="email" class="form-login" required><br><br>
